# Code Passport: Brazil Checklist

Market-specific audit checklist for Brazil. Used by the `/code-passport` skill to audit codebases targeting the Brazilian market.
